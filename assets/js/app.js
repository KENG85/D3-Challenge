...
export default function define(runtime, observer) {
    ...
    const fileAttachments = new Map([["data.csv",new URL("./data/data.csv",import.meta.url)],["data@1.csv",new URL("./data/data.csv",import.meta.url)]]);
    main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
    main.variable(observer()).define(["md"], function(md){return(
  md`# Scatterplot with Shapes
  
  This chart shows the relationship between Income and Obesity `
  )});
